 ...
 */
public class SnakeTileFactory implements TileFactory {
  @Override
  public Tile tileFromJson(JsonObject json, Board board) {
    int id = json.get("id").getAsInt();
    int exitId = json.get("exit-tile").getAsInt();

    SnakeTileStrategy strategy = new SnakeTileStrategy(board.getTile(id), board.getTile(exitId));
