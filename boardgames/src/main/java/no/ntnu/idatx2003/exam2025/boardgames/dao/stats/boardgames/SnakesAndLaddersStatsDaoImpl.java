...
public class SnakesAndLaddersStatsDaoImpl implements SnakesAndLaddersStatsDao {
  ...
  private static final String SQL_INSERT = "INSERT INTO snakes_and_ladders_stats "
      ...
      + "highest_dice_roll = CASE "
      + "WHEN excluded.highest_dice_roll > snakes_and_ladders_stats.highest_dice_roll "
      + "THEN excluded.highest_dice_roll "
      + "ELSE snakes_and_ladders_stats.highest_dice_roll "
      + "END, "
